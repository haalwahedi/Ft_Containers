...
namespace ft
{
    ...
    class set
    {
        public:
            ...
            typedef rbtree_set<value_type, Compare, node_type>    tree_type;
            ...
            typedef rbtree_rev_iterator<iterator>                      reverse_iterator;
            typedef rbtree_rev_iterator<const_iterator>                const_reverse_iterator;
